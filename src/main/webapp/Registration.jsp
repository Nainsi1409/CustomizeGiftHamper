...
<form action="CustomerRegServ" >
<!-- Registration Section -->
<div class="container-xxl py-5" >
    <div class="container">
        <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s" style="color: #333; font-weight: 600;">New User Registration</h1>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-6">
                <div class="wow fadeInUp card p-4 shadow-lg rounded-3 border-0" data-wow-delay="0.3s" style="border: 2px solid #cfd8dc; background-color: #ffffff;">
                        ...
                        <!-- Adding margin-bottom for spacing between fields -->
                        <div class="row g-3 mb-3">
                            <!-- Name Field -->
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    <label for="name" style="width: 100px; font-weight: 500; color: #555;">Name:</label>
                                    <input type="text" class="form-control rounded-3 shadow-sm" name="name" placeholder="Your Name" required style="margin-left: 10px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    <label for="email" style="width: 100px; font-weight: 500; color: #555;">Email:</label>
                                    <input type="email" class="form-control rounded-3 shadow-sm" name="email" placeholder="Your Email" required style="margin-left: 10px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    <label for="mobile" style="width: 100px; font-weight: 500; color: #555;">Mobile:</label>
                                    <input type="text" class="form-control rounded-3 shadow-sm" name="mobile" placeholder="Mobile" required style="margin-left: 10px;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mb-3">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center">
                                    <label for="city" style="width: 100px; font-weight: 500; color: #555;">City:</label>
                                    <input type="text" class="form-control rounded-3 shadow-sm" name="city" placeholder="City" required style="margin-left: 10px;">
                                </div>
                            </div>
                        </div>
